  ...
  <body >
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <form class="form-inline my-2 my-lg-0" action="index1_visitante.php" method="POST" name="procurar" style="position: absolute;left: 53%">
        ...
        ?>
          ...
          <div class="card-body">
            ...
            <ul class="small mt-3 list-unstyled card-text">
              ...
              <li><span class="font-weight-bold">Contato:</span> </li>
            </ul>
            <a href="vermais_visitante.php?ver=<?php echo $resultado['PRO_CODIGO'];?>"><button class="btn btn-success text-dark rounded">ver mais</button></a>
          </div>
        </div>      
